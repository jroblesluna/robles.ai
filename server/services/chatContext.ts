...
function getRouteDescription(pagePath: string): string {
  const routeDescriptions: Record<string, string> = {
    ...
    '/demos': `The visitor is on the "AI Demos Playground" — a catalog of interactive AI demos they can try live in the browser with no signup. Live demos available now: Identity Verification (computer vision / face recognition, at /try-identity), RAG Pipeline (NLP / retrieval-augmented generation, at /try-rag), Medical Image Analysis (computer vision / medical imaging, at /try-medical), LangChain Agent (LLM / agents & tools, at /try-langchain), Object Detection (computer vision, runs in browser, at /try-object-detection), Facial Emotion Recognition (computer vision, runs in browser, at /try-emotion), and Speech-to-Text & Diarization (real-time transcription + speaker separation + AI analysis, at /try-transcription). More demos are coming soon across sentiment analysis, demand forecasting, document extraction, image generation, recommendation systems, and fraud/anomaly detection. If a visitor is interested in a "coming soon" demo or wants a custom one for their use case, invite them to get in touch.`,
