...
const Testimonials = () => {
  ...
  const testimonialsData = t("testimonials.items", { returnObjects: true }) as TestimonialProps[];
  ...
  return (
    <section id="customers" className="py-16 bg-blue-50 scroll-mt-10">
      <motion.div
      ...
      >
        ...
        <motion.div variants={fadeIn} custom={0.3} className="relative mx-auto">
          ...
          <div className="flex flex-col items-center mt-10">
            <div className="flex justify-center mb-6">{renderIndicators()}</div>
